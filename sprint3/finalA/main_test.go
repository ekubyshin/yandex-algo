...
func Test_brokenSearch(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			"1",
			args{
				arr: []int{19, 21, 100, 101, 1, 4, 5, 7, 12, 13},
				k:   5,
			},
			6,
		},
		...
		},
		{
			"3",
			args{
				arr: []int{19, 21, 100, 101, 102, 3, 4, 5},
				k:   19,
			},
			0,
		},
		{
			"4",
			args{
				arr: []int{19, 21, 100, 101, 102, 103, 104, 105, 12},
				k:   19,
			},
			0,
		},
		{
			"5",
			args{
				arr: []int{100, 101, 102, 103, 104, 7, 12},
				k:   7,
			},
			5,
		},
